...
old = 'reshade::set_config_value(nullptr, dlss5_aio_menu::kConfigSection, "MfgMultiplier", mfg_value);'
new = 'reshade::set_config_value(nullptr, dlss5_aio_menu::kConfigSection, "MfgMultiplier", static_cast<const char *>(mfg_value));'
if old in s:
...
if new not in s:
    raise SystemExit("MFG config string conversion not found after fixup")
